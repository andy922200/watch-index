...
`data/` 保存四類正式資料：跨市場共用的腕錶配置目錄、各市場的在地化資訊、不可回寫的價格歷史，以及來源可追溯的旅客退稅政策。Catalog、market 與 price history 使用 brand-neutral v3 Schema；每份資料以 `brandId` 識別品牌，並以品牌官方完整參考號 `reference` 組成跨品牌唯一鍵 `watchId = brandId + ":" + reference`，例如 `rolex:m126500ln-0001`。目前正式內容仍僅涵蓋勞力士。

目前涵蓋奧地利、中國、瑞士、德國、西班牙、法國、英國、香港、義大利、日本、韓國、新加坡、泰國、台灣與美國共 15 個市場。每個市場都有 1,465 筆配置資料；各市場的價格幣別、含稅語意與更新時間可能不同，應以各自的價格歷史檔為準。
